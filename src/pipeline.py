...
class BM25RerankerPipeline(Pipeline):
    ...
    def __init__(self):
        ...
        self.corpus_map = {}
        self.multiplier = config.get("retrieval.reranking.candidate_multiplier", 2)
    ...
    def retrieve(self, query: str, candidate_depth: int = 100) -> List[Tuple[str, float]]:
        candidates = self.retriever.retrieve(query, top_k=int(candidate_depth * self.multiplier))
